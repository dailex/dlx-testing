...
final class CreateStandardArticleResource20170707191919 implements MigrationInterface
{
    ...
    private function up(): void
    {
        $this->putMappings(
            $this->getIndexName(),
            ['dlx-testing-article-standard' => $this->loadFile('article-standard-mapping-20170707191919.json')]
        );
    }
    ...
    private function down(): void
    {
        ...
        $this->reindexWithMappings($currentIndex, $revertedIndex, ['dlx-testing-article-standard' => null]);
